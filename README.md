<p align="center">
  <img src="assets/social-card.png" alt="MA vs NH — One Border, Two Economies" width="100%"/>
</p>
...
- A $100K earner retains:
  - **$83,903** in purchasing power in MA (9% income tax + 8.2% higher prices)
  - **$103,093** in NH (0% income tax + 3% lower prices)
  - **$19,190 real advantage for NH (22.9%)**
...
Already configured — just enable Pages in repo settings pointing to the `main` branch root.
